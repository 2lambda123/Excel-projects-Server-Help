...
public static class AssemblyInfo {
  ...
  public static string Guid {
    get {
      ...
      if (assembly != null) {
        ...
        if ((customAttributes != null) && (customAttributes.Length > 0))
          result = ((System.Runtime.InteropServices.GuidAttribute)
                        customAttributes[0])
                       .Value;
      }
      return result;
  ...
  /// </summary>
  /// <returns>A method that returns a string of the current file name
  ...
  public static void SetAssemblyFolderVersion() {
    try {
      if (System.Deployment.Application.ApplicationDeployment
              .IsNetworkDeployed) {
        Version ver = System.Deployment.Application.ApplicationDeployment
                          .CurrentDeployment.CurrentVersion;
        string versionNumber = string.Format(
            "{0}.{1}.{2}.{3}", ver.Major, ver.Minor, ver.Build, ver.Revision);
  ...
  /// </summary>
  /// <param name="iconName">The referenced icon name for the
  /// application.</param> <remarks> only run if deployed
  /// </remarks>
      ...
      try {
        ...
        AssemblyDescriptionAttribute asdescription =
            (AssemblyDescriptionAttribute)Attribute.GetCustomAttribute(
                code, typeof(AssemblyDescriptionAttribute));
        ...
        string clickOnceLocation =
            Path.GetDirectoryName(uriCodeBase.LocalPath.ToString());

        // the icon is included in this program
        string iconSourcePath =
            Path.Combine(clickOnceLocation, @"Resources\" + iconName);
  ...
  public static void OpenFile(string filePath) {
    try {
      ...
      MessageBox.Show("No application is assicated to this file type." +
